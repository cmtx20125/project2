...
public class ProfileDetailActivity extends AppCompatActivity {
    ...
    private TextView myName,myDate,myGender,myPhone,myAddress,myPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wodeli);
        ...
        // 救助按钮点击事件
        editbun.setOnClickListener(v -> {
            // 这里可以实现救助按钮的功能
            Toast.makeText(ProfileDetailActivity.this, "已请求！", Toast.LENGTH_SHORT).show();
            long createTimeMillis = user.getUserDate().getTime();
            startActivity(new Intent(this, EditUserActivity.class)
                    .putExtra("user", user).putExtra("userId",userId).putExtra("myName",user.getUserName())
                    .putExtra("myDate",createTimeMillis).putExtra("myPhone",user.getUserPhone())
                    .putExtra("myGender",user.getUserGender()).putExtra("myAddress",user.getUserAddress())
                    .putExtra("myIC",user.getUserPic()).putExtra("myPassword",user.getUserPwd()));
        });
        // 返回按钮点击事件
    ...
    private void initViews() {
        ...
        myPhone = findViewById(R.id.my_phone);
        myAddress = findViewById(R.id.my_address);
        ic = findViewById(R.id.my_pic);
        editbun = findViewById(R.id.btn_edit);
        myPassword = findViewById(R.id.my_password);
    ...
    private void updateArticleList(User usern) {
        ...
        myPhone.setText("个人手机号"+"    "+user.getUserPhone());
        myPassword.setText("个人密码"+"    "+user.getUserPwd());
