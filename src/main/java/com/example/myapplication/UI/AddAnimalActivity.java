...
public class AddAnimalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgCat.setOnClickListener(v ->{
            Intent intent = new Intent(AddAnimalActivity.this, PhotoShowActivity.class);
    ...
    private void handleSubmit() {
        ...
        reportId = getIntent().getStringExtra("publishId");
        // 示例：简单校验
        if (name.isEmpty()) {
...
// 创建文本参数（如 publishTag、publishContent 等）
        ...
        Call<HttpResponseEntityp> call = apiService.addAnimal(
        ...
        call.enqueue(new Callback<HttpResponseEntityp>() {
            ...
            public void onResponse(Call<HttpResponseEntityp> call, Response<HttpResponseEntityp> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if ("666".equals(result.getCode())) {
                        // 登录成功
                        Toast.makeText(AddAnimalActivity.this, "上传成功！", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        // 登录失败
                        Toast.makeText(AddAnimalActivity.this, result.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // 服务器错误
                    Toast.makeText(AddAnimalActivity.this, "服务器错误，请重试", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<HttpResponseEntityp> call, Throwable t) {
                ...
                // 网络请求失败
                Toast.makeText(AddAnimalActivity.this, "网络错误，请检查您的连接", Toast.LENGTH_SHORT).show();
            }
        });
