...
public class EditPetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgCat.setOnClickListener(v ->{
            Intent intent = new Intent(EditPetActivity.this, PhotoShowActivity.class);
    ...
    private void handleSubmit() {
        ...
        MultipartBody.Part coverPart = MultipartBody.Part.createFormData("animalImage", coverFile.getName(), requestCoverFile);
...
// 创建文本参数（如 publishTag、publishContent 等）
        ...
        Call<updateEntity> call = apiService.updatePet(
        ...
        call.enqueue(new Callback<updateEntity>() {
            ...
            public void onResponse(Call<updateEntity> call, Response<updateEntity> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if ("666".equals(result.getCode())) {
                        // 登录成功
                        Toast.makeText(EditPetActivity.this, "上传成功！", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditPetActivity.this, PetActivity.class).putExtra("userId",userId));
                        finish();
                    } else {
                        // 登录失败
                        Toast.makeText(EditPetActivity.this, result.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // 服务器错误
                    Toast.makeText(EditPetActivity.this, "服务器错误，请重试", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<updateEntity> call, Throwable t) {
                ...
                // 网络请求失败
                Toast.makeText(EditPetActivity.this, "网络错误，请检查您的连接", Toast.LENGTH_SHORT).show();
            }
        });
