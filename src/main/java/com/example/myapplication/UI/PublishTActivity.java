...
public class PublishTActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fabiaot);
    ...
    private void setupListeners() {
        ...
        btnAddImage.setOnClickListener(v -> {
            Intent intent = new Intent(PublishTActivity.this, PhotoShowActivity.class);
        ...
        jumpVideo.setOnClickListener(v ->{
            Intent intent = new Intent(PublishTActivity.this, PublishVActivity.class);
        ...
        tvContentJump.setOnClickListener(v -> {
            ...
            // 创建Intent并传递数据和图片
            Intent intent = new Intent(PublishTActivity.this, PublishTTActivity.class);
